from siteTemplate.models import SiteTemplate
...
"""
def run():
  # Créez une nouvelle instance de SiteTemplate
...
# Appeler la fonction run si le script est exécuté en tant que programme principal
